# admin-mui-theme Specification

## Purpose

Material Design 3 theming for the admin SPA: tonal palette derived from deepPurple seed color, light/dark mode toggle with system preference detection, design token parity with the Flutter client, schema-driven item-type accent colors, curated MUI icon registry, and CSS variable export.
